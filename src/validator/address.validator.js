...
export const addressValidator = (address) => {
    const schema = Joi.object({
        user_id: Joi.string().uuid().required().messages({
            ...
            "any.required": '"userId" maydoni talab qilinadi',
        }),
        ...
        address_line_1: Joi.string().max(255).required().messages({
            ...
            "string.max":
                '"address_line_1" uzunligi 255 ta belgidan oshmasligi kerak',
            "any.required": '"address_line_1" maydoni talab qilinadi',
        }),
        address_line_2: Joi.string().max(255).allow(null, "").messages({
            "string.max":
                '"address_line_2" uzunligi 255 ta belgidan oshmasligi kerak',
        }),
        ...
        postal_code: Joi.string().max(20).required().messages({
            ...
            "string.max":
                '"postal_code" uzunligi 20 ta belgidan oshmasligi kerak',
        ...
        phone_number: Joi.string()
            ...
            .messages({
                ...
                "string.pattern.base":
                    '"phone_number" faqat raqamlar, "-", "+" yoki probellarni qabul qiladi',
